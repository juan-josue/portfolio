...
function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center px-16 bg-zinc-900 text-zinc-200">
      <div className="flex flex-row justify-between gap-16">
        <div className="flex flex-col w-3/5 gap-16">
          <div className="flex flex-row justify-between items-top">
            <div className="flex flex-col gap-8">
              <h1 className="text-7xl font-bold font-title">
                Hey, I'm <br />
                <span className="text-indigo-500">Juan Gutierrez.</span>
                <br />
              </h1>
              <h2 className="text-3xl font-text">
                <span className="text-indigo-500">{'> '}</span>
                <Typewriter
                  words={["Web Developer", "Computer Science Major", "Bird Watcher"]}
                  loop={false}
                  cursor
                  typeSpeed={120}
                  deleteSpeed={100}
        ...
        <div className="flex flex-col gap-16">
          <div className="flex flex-col gap-8 font-text">
            ...
            >
              <h5 className="font-text">Ornipedia</h5>
              <svg
                className="w-4 h-4"
            ...
            <Link
              ...
              className="flex justify-between gap-8 border-b-2 border-zinc-200"
            >
              <h5 className="font-text">Tracktion</h5>
              <svg
                className="w-4 h-4"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
          ...
          <div className="flex flex-col gap-8 font-text">
            ...
            <Link
              ...
              className="flex justify-between gap-8 border-b-2 border-zinc-200"
            >
              <h5 className="font-text">GoDaddy</h5>
              <svg
                className="w-4 h-4"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
